...
import com.example.productcatalogservice.models.ProductOfferingCreateEventPayload;
...
public class ProductOfferingCreateEvent   {
  @JsonProperty("event")
  private ProductOfferingCreateEventPayload event;
  ...
  */
  ...
  public ProductOfferingCreateEvent eventTime(Date eventTime) {
  ...
  */
  ...
  public ProductOfferingCreateEvent timeOcurred(Date timeOcurred) {
