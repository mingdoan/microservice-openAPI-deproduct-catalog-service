...
import com.example.productcatalogservice.models.CategoryCreateEventPayload;
...
public class CategoryCreateEvent   {
  @JsonProperty("event")
  private CategoryCreateEventPayload event;
  ...
  */
  ...
  public CategoryCreateEvent eventTime(Date eventTime) {
  ...
  */
  ...
  public CategoryCreateEvent timeOcurred(Date timeOcurred) {
