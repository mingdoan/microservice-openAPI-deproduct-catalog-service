...
import com.example.productcatalogservice.models.ProductOfferingStateChangeEventPayload;
...
public class ProductOfferingStateChangeEvent   {
  ...
  */
  ...
  public ProductOfferingStateChangeEvent eventTime(Date eventTime) {
  ...
  */
  ...
  public ProductOfferingStateChangeEvent timeOcurred(Date timeOcurred) {
